...
env_settings = {
    ...
    'CtrlNet':dict(agent_class=importlib.import_module('algorithms.CtrlNet'),
                id="-5",
                env_name='RoboschoolHopper-v1',
                seed=2,
                record=False,
                ...
                algorithm_params = {'gamma':0.97, 
                                   ...
                                   'std_dev':['fixed', 0.3], 
                                   'target_update_rate':1.0},
                logs_path="/home/rae/RaeboSchool/workspace/logs/CtrlNet/1/"
                ),
    'A2C':dict(agent_class=importlib.import_module('algorithms.A2C'),
               ...
               algorithm_params = {'gamma':0.97, 
                                   ...
                                   'std_dev':['fixed', 0.5], 
                                   'target_update_rate':1.0},
               logs_path="/home/rae/RaeboSchool/workspace/logs/"
               ),
