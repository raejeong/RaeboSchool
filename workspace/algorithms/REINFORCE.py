...
class Agent:
  ...
  def __init__(self,
               ...
               training_params = {'total_timesteps':1000000,  
                                  'adaptive_lr':True, 
                                  'desired_kl':2e-3},
               network_params = {'policy_network':['fully_connected_network','large']},
  ...
  def train(self, saver=None, save_dir=None):
    ...
    while total_timesteps < self.training_params['total_timesteps']:
      ...
      self.print_stats(total_timesteps, total_episodes, best_average_reward, average_reward, kl, policy_network_loss, average_advantage, learning_rate, batch_size)
  ...
  # Print stats
  def print_stats(self, total_timesteps, total_episodes, best_average_reward, average_reward, kl, policy_network_loss, average_advantage, learning_rate, batch_size):
    ...
    print("{:>15} {:>15} {:>15} {:>15} {:>20} {:>20} {:>20} {:>10} {:>15}".format("total_timesteps", "episodes", "best_reward", "reward", "kl_divergence", "policy_loss", "average_advantage", "lr", "batch_size"))
    print("{:>15} {:>15} {:>15.2f} {:>15.2f} {:>20.5E} {:>20.2f} {:>20.2f} {:>10.2E} {:>15}".format(total_timesteps, total_episodes, best_average_reward, average_reward, kl, policy_network_loss, average_advantage, learning_rate, batch_size))
