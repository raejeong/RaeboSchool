...
if __name__ == "__main__":
    ...
    ax1.set_title('InvertedPendulum')
    line_width = 2
    alpha = 1.0
    a2c_color = 'green'
    a2s_color = 'blue'
    a2sL = tf_csv_to_plt('1.csv',line_width,a2s_color,alpha,ax1)
    a2cL = tf_csv_to_plt('2.csv',line_width,a2c_color,alpha,ax1)
    a2svL = tf_csv_to_plt('3.csv',line_width,'red',alpha,ax1)
